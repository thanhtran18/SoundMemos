package com.example.android.soundmemos;
...
import com.example.android.soundmemos.listeners.OnDatabaseChangedListener;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public com.example.android.soundmemos.RecordingItem getItemAt(int position) {
        ...
        if (c.moveToPosition(position)) {
            com.example.android.soundmemos.RecordingItem item = new com.example.android.soundmemos.RecordingItem();
    ...
    public class RecordingComparator implements Comparator<com.example.android.soundmemos.RecordingItem> {
        public int compare(com.example.android.soundmemos.RecordingItem item1, com.example.android.soundmemos.RecordingItem item2) {
    ...
    public void renameItem(com.example.android.soundmemos.RecordingItem item, String recordingName, String filePath) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_NAME, recordingName);
        cv.put(DBHelperItem.COLUMN_NAME_RECORDING_FILE_PATH, filePath);
    ...
    public long restoreRecording(com.example.android.soundmemos.RecordingItem item) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues cv = new ContentValues();
